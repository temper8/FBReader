...
#include "ZLbadaNetworkManager.h"
...
*/
	...
	/*
void ZLbadaNetworkManager::onFinished(QNetworkReply *reply) {
	if (!checkReply(reply))
		return;
...
void ZLbadaNetworkManager::readData(QNetworkReply *reply, ZLNetworkRequest *request) {
