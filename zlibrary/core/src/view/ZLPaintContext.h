...
//TODO	virtual const std::string realFontFamilyName(std::string &fontFamily) const = 0;

protected:
//TODO	virtual void fillFamiliesList(std::vector<std::string> &families) const = 0;
