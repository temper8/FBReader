...
//     indicatorTypeEntry->addDependentEntry(navigationEntry);
 ...
 //alex    indicatorTypeEntry->onStringValueSelected(indicatorTypeEntry->initialValue());
 //alex    showTextPositionEntry->onStateChanged(showTextPositionEntry->initialState());
 //alex     showTimeEntry->onStateChanged(showTimeEntry->initialState());
 }
