...
const ZLTypeId SystemOptionsDialogNode::TYPE_ID(ZLTreeActionNode::TYPE_ID);

const ZLTypeId &SystemOptionsDialogNode::typeId() const {
	return TYPE_ID;
}

const ZLTypeId ReadingOptionsDialogNode::TYPE_ID(ZLTreeActionNode::TYPE_ID);

const ZLTypeId &ReadingOptionsDialogNode::typeId() const {
	return TYPE_ID;
}

const ZLTypeId LookAndFeelOptionsDialogNode::TYPE_ID(ZLTreeActionNode::TYPE_ID);
...
const ZLTypeId ColorOptionsDialogNode::TYPE_ID(ZLTreeActionNode::TYPE_ID);

const ZLTypeId &ColorOptionsDialogNode::typeId() const {
	return TYPE_ID;
}

const ZLTypeId TextStylesTreeNode::TYPE_ID(ZLTreeActionNode::TYPE_ID);

const ZLTypeId &TextStylesTreeNode::typeId() const {
	return TYPE_ID;
}

const ZLTypeId TextStyleNode::TYPE_ID(ZLTreeActionNode::TYPE_ID);
